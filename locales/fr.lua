Locales['fr'] = {
	...
	['open_vault']					= 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au ~h~~m~coffre~s~',
	...
	['vehicle_spawner']				= 'Appuyez sur ~INPUT_CONTEXT~ pour ~h~~m~sortir un véhicule~s~',
	['store_vehicle']				= 'Appuyez sur ~INPUT_CONTEXT~ pour ~h~~m~ranger le véhicule~s~',
	...
	['assembling_alcohol']			= 'Vous venez de remplir ~g~%s~s~ bouteilles de whisky',
	['assembling_badluck']			= '~o~Malheureusement, quelques bouteilles se sont cassées durant l\'opération...~s~',

	-- Selling
	['menu_sell']					= 'Appuyez sur ~INPUT_CONTEXT~ pour ~h~~m~vendre toutes les bouteilles~s~',
	['not_enough_alcohol_sell']		= '~r~Vous n\'avez pas de bouteille de whisky à vendre...~s~',
	['selling_alcohol']				= 'Vous venez de vendre toutes vos bouteilles de whisky pour un montant de $~g~%s~s~',
